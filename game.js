...
// Размеры спрайтов
const PLAYER_WIDTH = 115;
const PLAYER_HEIGHT = 150;
const PLAYER_WRESTLE_WIDTH = 119;
const PLAYER_WRESTLE_HEIGHT = 129;
const PLAYER_WRESTLE_ATTACK_WIDTH = 161;
const PLAYER_WRESTLE_ATTACK_HEIGHT = 129;
const ENEMY_BOXER_WIDTH = 94;
const ENEMY_BOXER_HEIGHT = 147;
const ENEMY_BOXER2_WIDTH = 80;  // Размеры второго боксера
const ENEMY_BOXER2_HEIGHT = 143;
const ENEMY_WRESTLER1_WIDTH = 112;
const ENEMY_WRESTLER1_HEIGHT = 112;
const ENEMY_WRESTLER2_WIDTH = 112;
const ENEMY_WRESTLER2_HEIGHT = 110;
const BOSS1_WIDTH = 105;
const BOSS1_HEIGHT = 132;
const BOSS2_WIDTH = 115;
const BOSS2_HEIGHT = 154;
