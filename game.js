...
function calculateSpriteSizes() {
    ...
    return {
        // Игрок
        playerHeight: Math.max(canvasHeight * 0.10, minSize),
        playerWidth: Math.max((115 / 150) * (canvasHeight * 0.10), minSize),
        
        // Игрок в борцовской стойке
        playerWrestleHeight: Math.max(canvasHeight * 0.07, minSize),
        playerWrestleWidth: Math.max((119 / 129) * (canvasHeight * 0.07), minSize),
        
        // Атака игрока в борцовской стойке
        playerWrestleAttackHeight: Math.max(canvasHeight * 0.07, minSize),
        playerWrestleAttackWidth: Math.max((161 / 129) * (canvasHeight * 0.07), minSize),
        
        // Боксеры
        enemyBoxerHeight: Math.max(canvasHeight * 0.10, minSize),
        enemyBoxerWidth: Math.max((94 / 147) * (canvasHeight * 0.10), minSize),
        
        enemyBoxer2Height: Math.max(canvasHeight * 0.10, minSize),
        enemyBoxer2Width: Math.max((80 / 143) * (canvasHeight * 0.10), minSize),
        
        // Борцы
        enemyWrestler1Height: Math.max(canvasHeight * 0.07, minSize),
        enemyWrestler1Width: Math.max((112 / 112) * (canvasHeight * 0.07), minSize),
        
        enemyWrestler2Height: Math.max(canvasHeight * 0.07, minSize),
        enemyWrestler2Width: Math.max((112 / 110) * (canvasHeight * 0.07), minSize),
        
        // Боссы
        boss1Height: Math.max(canvasHeight * 0.11, minSize),
        boss1Width: Math.max((105 / 132) * (canvasHeight * 0.11), minSize),
        
        boss2Height: Math.max(canvasHeight * 0.11, minSize),
        boss2Width: Math.max((115 / 154) * (canvasHeight * 0.11), minSize)
    };
}
